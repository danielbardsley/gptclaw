...
| AGT-003 | Nested guidance pattern | 3 | Planned | [SPEC-005](../005-nested-guidance-pattern/spec.md) approved and implementation authorized on 2026-09-13. Template, five inert examples, infrastructure adoption, and offline checks implemented in [PR #11](https://github.com/danielbardsley/gptclaw/pull/11); resulting-policy review, CI, merge, and fresh-task remote acceptance remain pending. [Acceptance evidence](../005-nested-guidance-pattern/acceptance.md). |
