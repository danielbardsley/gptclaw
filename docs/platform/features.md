...
| AGT-003 | Nested guidance pattern | 3 | Draft | [SPEC-005](../005-nested-guidance-pattern/spec.md) proposes focused area guidance, one GptClaw infrastructure adoption, inert examples, and discovery/scope acceptance checks. Specification, design, and tasks are under review; implementation is not approved. |
